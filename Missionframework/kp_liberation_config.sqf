...
KP_liberation_cr_wounded_chance = 95;                                    // Chance (0-100) that there are wounded civilians right after capturing a sector.
...
KP_liberation_commander_actions = [
	...
	"76561198042929358", // Nightmare
	"76561198134643913", // Fire
